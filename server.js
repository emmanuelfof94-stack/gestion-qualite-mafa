...
httpsServer.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('╠══════════════════════════════════════════════════════╣');
  console.log('║  ⚠️  Certificat auto-signé — Acceptez l\'exception         ║');
  console.log('║     sécurité dans le navigateur la première fois.    ║');
  console.log('╚══════════════════════════════════════════════════════╝\n');
  console.log(`  QR Code URL (à scanner) : https://${LOCAL_IP}:${PORT}/badge\n`);
});
